    ...
    <div id="about-page" className="pt-24 pb-16 bg-[#F9F8F6] min-h-screen">
      <div id="about-container" className="max-w-4xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <p className="text-lg md:text-xl italic text-[#5c635f] font-light max-w-2xl mx-auto leading-relaxed">
            How One Mother's Love Became a Mission to Transform Spaces
          </p>
          <div className="w-12 h-[1px] bg-[#607564] mx-auto mt-6"></div>
        </motion.div>
        ...
        <div className="grid md:grid-cols-12 gap-8 items-center mb-10">
          ...
          >
            <p className="text-lg md:text-xl font-medium text-[#2C302E] leading-relaxed">
            ...
            <p className="text-lg md:text-xl font-medium text-[#2C302E]">
        ...
        >
          ...
          <section className="space-y-3">
            <h2 className="text-xl md:text-2xl font-serif text-[#2C302E] border-b border-[#e8e5df] pb-2">A Dream Earned with Dedication</h2>
            <p>
          ...
          {/* Section 2 */}
          <section className="space-y-3">
            <h2 className="text-xl md:text-2xl font-serif text-[#2C302E] border-b border-[#e8e5df] pb-2">The Moment That Changed Everything</h2>
            <p>
          ...
          {/* Section 3 */}
          <section className="space-y-3">
            <h2 className="text-xl md:text-2xl font-serif text-[#2C302E] border-b border-[#e8e5df] pb-2">A Passion She Already Carried</h2>
            <p>
          ...
          {/* Section 4 */}
          <section className="space-y-3">
            <h2 className="text-xl md:text-2xl font-serif text-[#2C302E] border-b border-[#e8e5df] pb-2">The Decision</h2>
            <p>
            ...
            <p>
              She brought with her the warmth and intentionality she had grown up with in Brazil, where the state of your home reflects the care you have for everyone who lives in it and everyone who visits. Where <em>cuidado</em>, or care, is not passive. It is active. It is chosen, every day.
            </p>
            <p>
              She brought her nursing precision: the attention to detail, the commitment to doing the work completely, and the understanding that shortcuts in care are never really shortcuts.
            </p>
            <p>
          ...
          {/* Section 5 */}
          <section className="space-y-3">
            <h2 className="text-xl md:text-2xl font-serif text-[#2C302E] border-b border-[#e8e5df] pb-2">What Shine Well Means</h2>
            <p>
            ...
            <p>
              Every home she and her team clean is a family whose mornings she is making lighter. Every office reception area they leave spotless is a business owner whose first impression she is protecting. Every deep clean they perform is a reset, for the space itself, but also for the person who lives or works inside it.
            </p>
            <blockquote className="border-l-4 border-[#607564] pl-6 italic my-5 text-lg md:text-xl text-[#2C302E] bg-[#f0ede6] py-2.5 pr-4 rounded-r-lg">
              ...
              <span className="block text-sm font-mono tracking-wider uppercase text-[#607564] mt-1.5 disappointed-Lina not-italic">Lina</span>
            </blockquote>
            <p>
              She built Shine Well to sustain her family. And along the way, she discovered that sustaining families, through clean, calm, and energized spaces, is exactly what Shine Well does for everyone it serves.
            </p>
          </section>

          {/* Section 6 */}
          <section className="space-y-3">
            <h2 className="text-xl md:text-2xl font-serif text-[#2C302E] border-b border-[#e8e5df] pb-2">Serving Kansas City with Heart</h2>
            <p>
          ...
          <div className="bg-[#f0ede6] border border-[#e8e5df] rounded-2xl p-6 text-center space-y-3 mt-10 shadow-sm">
            <Heart className="w-6 h-6 text-[#C86B53] mx-auto animate-pulse" />
            <h3 className="text-xl md:text-2xl font-serif text-[#2C302E]">Shine Well Cleaning Services</h3>
          ...
          {/* CTA Link */}
          <div id="about-cta-container" className="text-center pt-6">
            <Link 
              id="about-booking-link"
              to="/booking"
              className="inline-flex items-center gap-2 bg-[#C86B53] hover:bg-[#b55e47] text-white px-6 py-3 rounded-full font-medium text-base md:text-lg transition-all hover:shadow-xl hover:-translate-y-1"
            >
