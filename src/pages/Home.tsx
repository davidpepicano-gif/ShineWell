        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            >
              <div className="mb-4">
                <a
                  ...
                  className="group inline-flex items-center gap-2 sm:gap-2.5 bg-white hover:bg-[#F9F8F6] px-4 py-2 rounded-full border border-[#e8e5df] shadow-sm hover:shadow-md hover:border-[#CAD4CD] transition-all"
                  id="home-top-google-reviews-badge"
                >
                  ...
                  <div className="flex text-[#FBBC05] shrink-0">
                    {[1, 2, 3, 4, 5].map((i) => <Star key={i} aria-hidden="true" className="h-3.5 w-3.5 fill-current" />)}
                  </div>
                  <span className="text-xs sm:text-sm font-semibold text-[#2C302E] tracking-tight">
                    5-Star Rated on Google by Our Clients <span className="text-[#5c635f] font-normal hidden sm:inline">(5.0 ★ · 28 Reviews)</span>
                  </span>
                  <span className="text-[#607564] text-xs font-medium group-hover:text-[#C86B53] transition-colors ml-1">
                    See Reviews &raquo;
                  </span>
                </a>
              </div>
            ...
            >
              ...
              {/* Decorative Google Review Element */}
              <a 
                href="https://share.google/3oMRqAPyjGZaUcAO6" 
                target="_blank" 
                rel="noopener noreferrer"
                className="absolute -bottom-6 -left-6 bg-white p-5 rounded-2xl shadow-xl max-w-[260px] hidden md:block border border-[#e8e5df] hover:shadow-2xl hover:border-[#CAD4CD] transition-all group cursor-pointer"
                id="home-hero-floating-review-card"
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="flex text-[#FBBC05]">
                    {[1, 2, 3, 4, 5].map((i) => <Star key={i} className="h-4 w-4 fill-current" />)}
                  </div>
                  <span className="text-[11px] font-bold text-[#4285F4] bg-blue-50 px-2 py-0.5 rounded-full border border-blue-100">
                    Google 5.0 ★
                  </span>
                </div>
                <p className="font-serif text-[#2C302E] leading-snug text-sm mb-2">"It feels like a brand new house every time they leave."</p>
                <span className="text-xs text-[#607564] font-medium group-hover:text-[#C86B53] transition-colors flex items-center gap-1">
                  5-Star Google Client Review &raquo;
                </span>
              </a>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col items-center text-center mb-10 gap-4">
            <div className="max-w-2xl flex flex-col items-center">
              ...
              >
                ...
                <div className="flex text-[#FBBC05]">
                  {[...Array(5)].map((_, i) => <Star key={i} aria-hidden="true" focusable="false" className="h-4 w-4 fill-current" />)}
                </div>
            ...
            <div className="flex gap-4">
              <button onClick={scrollPrev} aria-label="Previous testimonial" className="w-12 h-12 rounded-full border border-[#e8e5df] flex items-center justify-center text-[#607564] hover:bg-[#F9F8F6] transition-colors">
                <ChevronLeft aria-hidden="true" focusable="false" className="w-6 h-6" />
              </button>
              <button onClick={scrollNext} aria-label="Next testimonial" className="w-12 h-12 rounded-full border border-[#e8e5df] flex items-center justify-center text-[#607564] hover:bg-[#F9F8F6] transition-colors">
