...
export default function FaqPage() {
  const faqs = [
    ...
    },
    {
      ...
      a: "While we cannot warranty our exact time of arrival because we give every home the attention it deserves and requires, we do offer arrival windows for your convenience. Shine Well uses software to log your preferences so our services are as minimally disruptive as possible."
    },
    {
      q: "What do you mean by \"window of arrival\"?",
      a: "When you schedule housecleaning services with Shine Well, we’ll give you an arrival timeframe of three to four hours. Because we give homes the individualized attention they deserve, we’re not able to provide an exact time of arrival, but we do our best to ensure that our cleaning plan doesn’t interfere with your schedule."
    },
    {
      q: "What if something's damaged during a service?",
      a: "At Shine Well, we treat every single home we clean with the utmost respect. If something happens to break during our routine service, we’ll do our best to repair or replace the item. Our residential housekeepers are fully insured, so claims can be filed when appropriate."
    },
    {
    ...
    {
      q: "How do I pay?",
      a: "Payments are due on the day of your scheduled service. Most of our valued customers leave cash or a check on the kitchen counter, but we also accept credit card payments. If you do choose to write us a check, please make it payable to Shine Well."
    },
    {
    ...
    },
    {
      ...
      a: "Over the years, we’ve found that the first cleaning service brings a home up to a specific standard and Shine Well is committed to upholding that standard. That’s why our initial cleaning may take longer and cost a little more than the rest of your services. We need the extra time to properly begin the process of eliminating mildew, soap scum, dust, and dirt from your home. Contact us to request a free estimate."
    },
    {
    ...
    },
    {
      ...
      a: "We’re recognized for being affordable and flexible. Some individual cleaning companies are able to offer lower rates because they don’t cover liability insurance or workers compensation. Shine Well is proud to provide these benefits that ensure our customers’ peace of mind while still being able to offer competitive rates for our services."
    },
    {
      q: "Do you always send the same housecleaners?",
      a: "We believe that it’s very important to always send the same team to clean your home and we do everything in our control to make this possible. If a member of your team is absent, we’ll do our best to find the most suitable replacement. All of our residential housekeepers undergo extensive Shine Well training to ensure that the quality of our work is always consistent."
    },
    {
