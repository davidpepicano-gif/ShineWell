      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12">
        ...
        <nav aria-label="Breadcrumb" className="text-sm text-[#5c635f] mb-6 flex items-center gap-2">
          <ol className="flex items-center gap-2 list-none p-0 m-0">
            ...
            <li aria-hidden="true">/</li>
            <li><span className="text-[#2C302E] font-medium" aria-current="page">Salon, Studio &amp; Fitness Cleaning</span></li>
          </ol>
        </nav>
        ...
        <figure className="max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-md mb-16 border border-[#e8e5df]">
          ...
          />
          <figcaption className="sr-only">Professional salon and wellness studio deep cleaning</figcaption>
        </figure>
        ...
        <section aria-labelledby="studio-services-heading" className="max-w-5xl mx-auto mb-16">
          <div className="text-center mb-10">
            <h2 id="studio-services-heading" className="text-2xl sm:text-3xl font-serif text-[#2C302E] mb-3">
              What we clean in salons, studios &amp; fitness spaces
            </h2>
        ...
        <section aria-label="Flexible Scheduling" className="max-w-4xl mx-auto bg-gradient-to-r from-[#8BA192]/10 via-[#CAD4CD]/20 to-[#8BA192]/10 p-8 sm:p-10 rounded-2xl border border-[#CAD4CD]/50 mb-16">
        ...
        <section aria-labelledby="why-wellness-heading" className="max-w-5xl mx-auto mb-16">
          <div className="text-center mb-10">
            <h2 id="why-wellness-heading" className="text-2xl sm:text-3xl font-serif text-[#2C302E] mb-3">
              Why KC wellness &amp; beauty businesses choose ShineWell
            </h2>
            <p className="text-[#5c635f] text-base max-w-2xl mx-auto">
        ...
        {/* Service Area */}
        <section aria-labelledby="salon-areas-heading" className="max-w-4xl mx-auto bg-white p-8 sm:p-10 rounded-2xl border border-[#e8e5df] shadow-sm mb-16 text-center">
          ...
          <h2 id="salon-areas-heading" className="text-2xl sm:text-3xl font-serif text-[#2C302E] mb-3">
